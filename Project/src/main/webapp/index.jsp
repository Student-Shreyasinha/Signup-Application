        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./Signin.jsp">eExam</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./Signin.jsp">OpenForum</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./box.jsp">eRepository</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./Signin.jsp">myWall</a>
                    </li>
                ...
                <a href="./Signin.jsp"><input class="btn btn-primary" type="button" value="LogIn/Sign-Up"></a>
            </div>
        </div>
    </nav>
